...
def plan_pick_and_place(req):
	...
	# Get the pose of the "start" named target
	start_pose_values = move_group.get_named_target_values("start")

    # Pre grasp - position gripper directly above target object
    pre_grasp_pose = plan_trajectory(move_group, start_pose_values, current_robot_joint_configuration)
...
# Put the arm in the strech position
print("Go to strech position.")
arm_group = moveit_commander.MoveGroupCommander("arm")
arm_group.set_named_target("strech")
plan1 = arm_group.go()

# Close the gripper
print("Close the gripper")
hand_group.set_named_target("closed_all")
plan2 = hand_group.go()

# Put the arm in the play position
print("Go to play position.")
arm_group = moveit_commander.MoveGroupCommander("arm")
arm_group.set_named_target("play")
plan1 = arm_group.go()

# Put the arm in the up position
print("Go to up position.")
arm_group = moveit_commander.MoveGroupCommander("arm")
