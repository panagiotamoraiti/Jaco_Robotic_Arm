...
{
    [Serializable]
    public class JacoMoveitJointsMsg : Message
    {
        public const string k_RosMessageName = "jaco_unity/JacoMoveitJoints";
        ...
        public JacoMoveitJointsMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
            this.joints = joints;
        ...
        public static JacoMoveitJointsMsg Deserialize(MessageDeserializer deserializer) => new JacoMoveitJointsMsg(deserializer);

        private JacoMoveitJointsMsg(MessageDeserializer deserializer)
        {
