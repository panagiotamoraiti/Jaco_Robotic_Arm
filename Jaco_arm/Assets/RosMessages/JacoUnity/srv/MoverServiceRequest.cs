...
namespace RosMessageTypes.JacoUnity
{
    ...
    {
        public const string k_RosMessageName = "jaco_unity/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public JacoMoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new JacoMoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(JacoMoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = JacoMoveitJointsMsg.Deserialize(deserializer);
